...
class Tacotron2(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # print("text:",transcript_outputs.shape)
        # print("gst:",gst_outputs.shape)
        # print("speaker:",embedded_speakers.shape)
        
        #embedded_speakers = embedded_speakers.expand_as(transcript_outputs)
